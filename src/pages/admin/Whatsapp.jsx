...
import { HiPaperAirplane, HiClock, HiChat, HiUserGroup, HiCalendar, HiExternalLink } from 'react-icons/hi';
    ...
    <div className="animate-fade-up" style={{ fontSize: '115%' }}>
      ...
      <div className="flex gap-2 mb-6">
        <Boton tipo={vista === 'enviar' ? 'primary' : 'outline'} onClick={() => setVista('enviar')}>
          <HiPaperAirplane className="w-4 h-4 mr-1.5 inline-block" />Enviar
        </Boton>
