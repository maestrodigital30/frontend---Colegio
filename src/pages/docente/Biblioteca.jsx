...
export default function BibliotecaDocente() {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Material educativo disponible para consulta y descarga</p>
      </div>
              ...
              <div key={m.id} className="bg-white border border-slate-200 rounded-2xl p-4 hover:shadow-md transition-shadow">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {enlace && <p className="text-xs text-slate-400 mt-0.5 truncate flex items-center gap-1"><HiLink className="w-3 h-3" />{m.ruta_archivo}</p>}
